gear = {
 ...
 'exhausted_lantern_hoard': {'bgcolor': 'ddd','name': 'Exhausted Lantern Hoard'},
 'leather_worker': {'bgcolor': '7F462C', 'color': 'FFF','name': 'Leather Worker'},
 ...
 'stone_circle': {'bgcolor': '835C3B', 'color': 'FFF', 'name': 'Stone Circle'},
...
resources = {
 ...
 'screaming_antelope_resources': {'bgcolor': 'DCD900','name': 'Screaming Antelope Resources'},
 'strange_resources': {'bgcolor': '9DC209', 'name': 'Strange Resources'},
 'vermin': {'bgcolor': '99CC66', 'name': 'Vermin'},
 'white_lion_resources': {'bgcolor': 'DCD900', 'name': 'White Lion Resources'},

 # expansions
 'dragon_king_resources': {'bgcolor': 'DCD900', 'expansion': 'dragon_king','name': 'Dragon King Resources', 'excluded_campaigns': ['people_of_the_stars']},
 'dung_beetle_knight_resources': {'bgcolor': 'DCD900', 'expansion': 'dung_beetle_knight','name': 'Dung Beetle Knight Resources'},
 'flower_knight_resources': {'bgcolor': 'DCD900', 'expansion': 'flower_knight', 'name': 'Flower Knight Resources'},
 'gorm_resources': {'bgcolor': 'DCD900', 'expansion': 'gorm','name': 'Gorm Resources'},
 'spidicules_resources': {'bgcolor': 'DCD900', 'name': 'Spidicules Resources', 'expansion': 'spidicules'},
 'sunstalker_resources': {'bgcolor': 'DCD900', 'expansion': 'sunstalker', 'name': 'Sunstalker Resources'},
}
