...
PROJECT_ABS_PATH=/home/toconnell/kdm-manager/v2/api.thewatcher.io/
WORLD_DAEMON=/home/toconnell/kdm-manager/v2/api.thewatcher.io/world_daemon.py
...
case "$1" in
	...
	status)
        ...
        ;;
	*)
		echo "Usage: $NAME {dev|enable|disable|start|stop|restart|status}" >&2
		exit 3
esac
